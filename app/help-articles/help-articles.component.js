...
angular.module('helpArticles').
    component('helpArticles', {
        templateUrl: '/app/help-articles/help-articles.html',
        controller: function($scope){
            // $http.get("/app/json/category.json", "/app/json/articles.json").then(successCallback, errorCallback);
